...
@section('content')
    ...
    <div id="tarjetas-contenedor" style="width: 100%; height: 100%; display: table;">
        <div class="tarjeta-row" style="display: table-row; columns: 2;">
            @for ($i = 0; $i < 8; $i++)
                <div class="tarjeta-empresa" style="
                    display: table-cell; 
                    width: 50%; 
                    ...
                    vertical-align: top;
                    background: #fefef5; /* Color neutro y sofisticado */
                    box-shadow: 3px 3px 8px rgba(0, 0, 0, 0.2);
                    font-family: 'Arial', sans-serif;">
                    
                    <img src="{{ asset('dist/img/distribuidora.jpg') }}" alt="Logo Empresa" class="logo" style="
                        width: 60px; 
                        height: 60px; 
                        border-radius: 50%; 
                        margin-bottom: 10px;">
                    
                    <h2 class="nombre" style="
                        color: #17202a; 
                        font-weight: bold; 
                        margin: 5px 0;
                        font-size: 20px;
                        font-family: 'Georgia', serif;">{{ $empresa->nombre }}</h2>
                    
                    <hr style="width: 80%; border-top: 1px solid #bbb;">
                    
                    <p style="color: #2c3e50; margin: 8px 0; font-weight: 500; font-family: 'Verdana', sans-serif;"><i class="fas fa-map-marker-alt"></i> {{ $empresa->direccion }}</p>
                    <p style="color: #2c3e50; margin: 8px 0; font-weight: 500; font-family: 'Verdana', sans-serif;"><i class="fas fa-phone"></i> {{ $empresa->telefono }}</p>
                    <p style="color: #2c3e50; margin: 8px 0; font-weight: 500; font-family: 'Verdana', sans-serif;"><i class="fas fa-envelope"></i> {{ $empresa->email }}</p>
                    ...
                    <p class="slogan" style="
                        ...
                        font-size: 13px; 
                        margin-top: 10px;
                        font-family: 'Times New Roman', serif;">"Compromiso y calidad en cada paso."</p>
                </div>
